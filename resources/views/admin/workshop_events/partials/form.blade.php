<div class="form-group col-sm-3">
  {{ Form::label('workshop_id', 'Categoría:') }} <code>*</code>
  {{ Form::select('workshop_id', $category, null, ['class' => 'custom-select', 'placeholder' => 'Categoría', 'required']) }}
</div>
...
<div class="form-group col-sm-3">
  {{ Form::label('event_date', 'Fecha del taller:') }} <code>*</code>
  {{ Form::date('event_date', null, ['class' => 'form-control', 'placeholder' => 'Fecha del taller', 'required']) }}
</div>
...
<div class="form-group col-sm-3">
  ...
  @if (Route::currentRouteName()=="workshop_events.edit")
        <img src="{{ $workshop_event->banner1 }}" alt="" style="height:3rem">
    @endif
  </div>
</div>
...
<div class="form-group col-sm-3">
  ...
  @if (Route::currentRouteName()=="workshop_events.edit")
        <img src="{{ $workshop_event->banner2 }}" alt="" style="height:3rem">
    @endif
  </div>
</div>
...
<div class="form-group col-sm-3">
  ...
  <div id="holder3" style="margin-top:15px;max-height:100px;">
    @if (Route::currentRouteName()=="workshop_events.edit")
      <img src="{{ $workshop_event->image1 }}" alt="" style="height:5rem">
    @endif
  </div>
</div>
...
<div class="form-group col-sm-3">
  ...
  <div id="holder4" style="margin-top:15px;max-height:100px;">
    @if (Route::currentRouteName()=="workshop_events.edit")
      <img src="{{ $workshop_event->image2 }}" alt="" style="height:5rem">
    @endif
  </div>
</div>

<div class="form-group col-sm-4">
  {{ Form::label('price', 'Precio S/:') }} <code>*</code>
...
<div class="px-3 col-sm-12 mb-3">
  <div class="card shadow col-sm-12 px-0">
    ...
    <div class="texto row px-3">
      @if (Route::currentRouteName()=="workshop_events.create")
      ...
      @if (Route::currentRouteName()=="workshop_events.edit")
        ...
        @php $var_col = (count($workshop_event->images)>1)?'col-md-4':'col-md-4'; @endphp
...
<script>
	$(document).ready(function(){
		...
		@if (Route::currentRouteName()=="workshop_events.edit")
      var i={{ count($workshop_event->images)+1 }};
    @else
      var i=1;
    @endif
