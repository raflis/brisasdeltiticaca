        ...
        <div class="row layout-body">
            <div class="col-sm-12">
                <div class="card shadow">
                    ...
                    {!! Form::model($event, ['route' => ['one_events.update', $event->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) !!}
                    <div class="card-body row">
                        <div class="col-sm-12">
                            @include('admin.includes.alert')
                        </div>
                        @include('admin.one_events.partials.form')
                    </div>
                </div>
            </div>
            <div class="col-sm-12 my-4">
                ...
                <a class="btn btn-danger py-2 px-3" href="{{ route('one_events.index') }}">Atrás</a>
                {!! Form::close() !!}
            </div>
        </div>
