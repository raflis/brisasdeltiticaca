<div class="form-group col-sm-6">
  {!! Form::label('image_post','Imagen de la cabacera:',['class'=>'mt-3']) !!} <strong>(1920 x 405px)</strong><code>*</code>
  <div class="input-group">
      ...
      {!! Form::text('image_post',null,['class'=>'form-control','id'=>'thumbnail1', 'required']) !!}
  </div>
...
<div class="form-group col-sm-6">
  {!! Form::label('image_blog','Imagen para mostrar en listado:',['class'=>'mt-3']) !!} <strong>(500 x 327px)</strong><code>*</code>
  <div class="input-group">
      <span class="input-group-btn">
      ...
      {!! Form::text('image_blog',null,['class'=>'form-control','id'=>'thumbnail2', 'required']) !!}
  </div>
  <div id="holder2" style="margin-top:15px;max-height:100px;">
  @if (Route::currentRouteName()=="posts.edit")
        <img src="{{ $post->image_blog }}" alt="" style="height:5rem">
  @endif
  </div>
</div>
...
<div class="form-group col-sm-12">
  ...
  {{ Form::textarea('summary', null, ['class' => 'form-control', 'placeholder' => 'Resumen', 'rows' => 3, 'required']) }}
</div>
